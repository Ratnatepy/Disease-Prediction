...
st.markdown("<h4 style='text-align: center;'>Department of Applied Mathematics and Statistics</h4>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;'>Mini Project</h3>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center;'>Disease Diagnosis Predictor</h2>", unsafe_allow_html=True)
st.markdown("<h6 style='text-align: right;'>Deploy By Group-2</h6>", unsafe_allow_html=True)
